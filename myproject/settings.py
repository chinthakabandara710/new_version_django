...
SECRET_KEY = 'django-insecure-hym%jwz$ewd218p&n$)ptpfy*r4@xmpk#zqwt^v^9(1i(^!!-b'
...
CSRF_TRUSTED_ORIGINS = [
    'https://new-version-django-fmwp2km6v-chinthakas-projects-e308d82b.vercel.app'
]
...
INSTALLED_APPS = [
    ...
    'rest_framework',  # Include DRF for API development
